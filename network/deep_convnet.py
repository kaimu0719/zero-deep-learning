...
class DeepConvNet:
    ...
    def __init__(
        ...
        pre_node_nums = np.array([
            1 * 3 * 3,  # 入力層のノード数
            conv_param_1['filter_num'] * conv_param_1['filter_size'] * conv_param_1['filter_size'],  # 1層目のフィルター数
            conv_param_2['filter_num'] * conv_param_2['filter_size'] * conv_param_2['filter_size'],  # 2層目のフィルター数
            conv_param_3['filter_num'] * conv_param_3['filter_size'] * conv_param_3['filter_size'],  # 3層目のフィルター数
            conv_param_4['filter_num'] * conv_param_4['filter_size'] * conv_param_4['filter_size'],  # 4層目のフィルター数
            conv_param_5['filter_num'] * conv_param_5['filter_size'] * conv_param_5['filter_size'],  # 5層目のフィルター数
            conv_param_6['filter_num'] * conv_param_6['filter_size'] * conv_param_6['filter_size'],  # 6層目のフィルター数
            hidden_size  # 隠れ層のノード数
        ])
        weight_init_scales = np.sqrt(2.0 / pre_node_nums) # ReLUを使う場合に推奨される初期値（Heの初期値）
